...
\begin{figure}[H]
	\begin{center}
		...
		\caption{Flexsensor (Quelle: \textcolor{blue}{\cite{Flexsensorabbildung}})}
...
\begin{figure}[H]
	\begin{center}
		...
		\caption{Servomotor (Quelle: \textcolor{blue}{\cite{Servoabbildung}})}
...
\begin{figure}[H]
	\begin{center}
		...
		\caption{UART erklärendes Diagramm (Quelle: \textcolor{blue}{\cite{UARTabbildung}})}
		\label{fig:UART}		
	\end{center}
\end{figure}
