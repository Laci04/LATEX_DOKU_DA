...
\paragraph{Definition und Bedetung}
\hfill \break
\hfill \break
...
\subsubsection{GNU GPL (General Public License)}
...
Rechte gewährt. \footnote{\cite{}}  Dadurch ist kein juristisches Fachwissen mehr erforderlich, um ein Werk für die 
...
Beschneidung der Rechte für bestimmte Personen ist allerdings in keinem Fall zulässig. \footnote{\cite{}} \\
\\
...
aufgeteilt werden. \footnote{\cite{rubigm1}} \\
\\
...
folgenden Punkt werden diese Bereiche genannt und näher beschrieben. \footnote{\cite{rubigm1}}\\
\\
...
Schutzmaßnahmen vorhanden sein müssen. \footnote{\cite{rubigm2}} \\
\begin{figure}[H]
	\begin{center}
		\scalebox{0.4}
...
Kontakte zwischen Mensch und Roboter vermieden werden sollen. \footnote{\cite{rubigm2}}\\
\begin{figure}[H]
	\begin{center}
		\scalebox{0.4}
...
Synchronisation und Koexistenz. \footnote{\cite{rubigm2}}\\
\begin{figure}[H]
	\begin{center}
		\scalebox{0.4}
...
Arbeitsablaufs sein. \footnote{\cite{rubigm2}}\\
\begin{figure}[H]
	\begin{center}
		\scalebox{0.4}
