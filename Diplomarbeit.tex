...
\includepdf[fitpaper]{/Users/laci/Schule/Diplomarbeit_GitHub/LATEX_DOKU_DA/src/Datenbankansuchen.pdf}
...
\vspace {2mm}
	...
	\begin{tabular} {|p {6cm}|p{10cm}|}
	 \hline 
		...
		\includegraphics[width=0.58\textwidth]{/Users/laci/Schule/Diplomarbeit_GitHub/LATEX_DOKU_DA/src/schematic_drawing.jpeg} \par Overview of the final integrated system
		}\\
	 \hline
	  \multicolumn{2}{l}{\large{ \textbf{}}}\\
	 \hline
...
\vspace {1mm}
	...
	\begin{tabular} {|p {6cm}|p{10cm}|}
	 \hline 
		...
		\includegraphics[width=0.58\textwidth]{/Users/laci/Schule/Diplomarbeit_GitHub/LATEX_DOKU_DA/src/schematische_Darstellung.jpeg} \par Vollständiger funktionaler Überblick des finalen Systems
		}\\
	 \hline
	  \multicolumn{2}{l}{\large{ \textbf{}}}\\
	 \hline
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|}
		...
		\hline
		40 & \fcolorbox{white}{white}{\parbox{5cm}{ - Griffkraftanzeige (in kg)}} & Y & 50 \\
        \hline
...
\begin{itemize}
	...
	\item \textquote{Grafische Benutzeroberflächen, Ideen und Grundsätze des Programms, abstrakte Problem-\\stellungen, technische Schnittstellen, Webseiten, Datenbanken, Datenstrukturen und Daten.} \footnote{\cite{Ionos10}}
\end{itemize}
\hfill \break
...
wozu auch die Mensch-Roboter-Kol-\\laboration gehört. \\
\\
...
müssen. Diese Kennzeich-\\nung dient der Sicherheit der Benutzer und muss von jedem 
...
diese Sicherheits-\\maßnahmen zur Vermeidung von Kollisionen, wäre die 
...
potenzieller Gefahren-\\quellen in Bezug auf die Mechanik geachtet werden. Dies gilt 
...
\begin{itemize}
	...
	beiden Finger-\\gliedern, welche zu einem für mehr Reibung gesorgt haben als auch den einzelnen 
...
\hfill \break
\hfill \break
Der Mechanismus der zweiten Versuchshand, welche den Namen \textquote{Entwicklungsstufe: InMoov} trägt, ist äußerst umfangreich und weist meist bessere Lösungen für Features der ersten Versuchs-\\hand, aus [\textcolor{blue}{\autoref{chap:Entwicklungsstufe: intitial}}], auf. \\
\\
\begin{figure}[H]
	\begin{center}
		\scalebox{0.9}
...
\end{figure}
\hfill \break
Während des Gusses ist Silikon ausgetreten, obwohl bereits im Vorhinein vorgesorgt wurde, dass dies nicht passiert – wie beispielsweise durch die Verschraubungsmöglichkeiten, mit denen beide Teile aneinander gepresst werden sollen oder die Steckvorrichtung. 
...
unteren Hälfte der Gussform in [\textcolor{blue}{\autoref{fig:Gussform1}}] gehört das rote und braune Element und zu der oberen gehören wie in [\textcolor{blue}{\autoref{fig:Gussform2}}] sichtbar das beige und graue Element. Befestigt werden die beiden Teile jeweils mit vier Stiften in Form einer 
...
Um diesem Problem entgegenzuwirken, ohne das Modell aus Kostengründen neu drucken zu müssen, gab es folgende Lösungsversuche:
\begin{itemize}
...
\end{figure}
\hfill \break
Die realisierte Hand, welche eine von Gael Levin erweiterte Version der modellierten Hand aus
...
von der Abteilung \textquote{Elektronik und technische Informatik} abgenommen und im Robotik-Unterricht erweitert werden soll. \\
...
\hfill \break
\hfill \break
Es gibt viele Möglichkeiten die Werte, die man von jedem einzeln angebrachten Flexsensor [siehe \textcolor{blue}{\autoref{chap:Flexsensor}}] ausliest, zu übertragen. Wichtig ist es, dass 
...
\\
Dieser Modus ist im Vergleich zum zweiten einfacher und besteht nur aus einer \textquote{Datenroute}. Die über das ESP-NOW Protokoll empfangenen Daten, welche 
...
Unterpro-\\grammen zusammen, diese werden als \textquote{Komponente} bezeichnet und bringen zahlreiche Vorteile mit sich. Unter anderem ermöglichen diese, dass 
...
Überblick und Effizienz im Programm des Ausgabesubsystems gesorgt. \\ Unter \textquote{individuellen Komponenten} können eigens entwickelte Unterprogramme verstanden 
...
\hfill \break
\normalsize
Das Unterprogramm prüft ab, ob die Grundbedingung, somit das erforderte Format wie in [\textcolor{blue}{\autoref{par:Drahtlose Kommunikation}}] beschrieben, erfüllt wird. \\
...
HCPCA9685.Servo(rueckgabe.servoIndex, value_out);
\end{lstlisting}
\hfill \break
\normalsize
...
\\
Im unteren, rechten Bereich von [\textcolor{blue}{\autoref{fig:UI_Oberfläche}}], befinden sich die $Kontrollanzeigen$ für die Servostellungen und die Griffkraft. Mithilfe des Protokolls [siehe \textcolor{blue}{\autoref{chap:Kommunikation-Protokolle}}], werden
...
%--------------------------------------------------------------------------
%==TESTS-UND-MESSUNGEN=====================================================
\section{Testen der Flexsensoren [\textcolor{blue}{Schweitzer}]}
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|c|}  % c für zentrierte Ausrichtung, l für linksbündig
		...
		\hline
		09.11.2023 & 3,5 & 9:50 - 13:20 & Ladislaus Szabo & \fcolorbox{white}{white}{\parbox{5cm}{"Hardwarebeschreibung" \\verfasst}} \\
		\hline
...
\begin{figure}[H]
	\begin{center}
		\scalebox{1.45}
		{\includegraphics[width=0.8 \linewidth, angle=-90]{Hand_oben}}
...
\begin{figure}[H]
	\begin{center}
		\scalebox{1.55}
		{\includegraphics[width=0.8 \linewidth, angle=-90]{Hand_3D}}
		%\caption{PCB Layout Eingabesubsystem Version 1}
		\label{fig:Hand_3D}		
	\end{center}
\end{figure}
\begin{figure}[H]
	\begin{center}
		\scalebox{1.6}
		{\includegraphics[width=0.8 \linewidth, angle=-90]{Antriebsmechanik_3D}}
		%\caption{PCB Layout Eingabesubsystem Version 1}
...
\begin{figure}[H]
	\begin{center}
		\scalebox{1.55}
		{\includegraphics[width=0.8 \linewidth, angle=-90]{Antriebsmechanik_oben}}
		%\caption{PCB Layout Eingabesubsystem Version 1}
...
\begin{figure}[H]
	\begin{center}
		\scalebox{1.6}
		{\includegraphics[width=0.8 \linewidth, angle=-90]{Antriebsmechanik_S1}}
		%\caption{PCB Layout Eingabesubsystem Version 1}
...
\begin{figure}[H]
	\begin{center}
		\scalebox{1.6}
		{\includegraphics[width=0.8 \linewidth, angle=-90]{Antriebsmechanik_s2}}
		%\caption{PCB Layout Eingabesubsystem Version 1}
...
\begin{figure}[H]
	\begin{center}
		\scalebox{1.6}
		{\includegraphics[width=0.8 \linewidth, angle=-90]{Antriebsmechanik_unten}}
		%\caption{PCB Layout Eingabesubsystem Version 1}
...
\begin{figure}[H]
	\begin{center}
		\scalebox{1.2}
		{\includegraphics[width=0.8 \linewidth]{Einzeln_3D}}
		%\caption{PCB Layout Eingabesubsystem Version 1}
...
\begin{figure}[H]
	\begin{center}
		\scalebox{1.4}
		{\includegraphics[width=0.8 \linewidth, angle=-90]{Einzeln_oben}}
		%\caption{PCB Layout Eingabesubsystem Version 1}
...
\begin{figure}[H]
	\begin{center}
		\scalebox{1.4}
		{\includegraphics[width=0.8 \linewidth, angle=-90]{Einzeln_S1}}
		%\caption{PCB Layout Eingabesubsystem Version 1}
...
\begin{figure}[H]
	\begin{center}
		\scalebox{1.4}
		{\includegraphics[width=0.8 \linewidth, angle=-90]{Einzeln_S2}}
		%\caption{PCB Layout Eingabesubsystem Version 1}
