...
\subsubsection{Eingabesubsystem}
...
Die Sensorik besteht aus Flexsensoren. Der Output dieser, wird durch eine Messschaltung an einen Mikrokontroller übertragen.
Die Datenübertragung erfolgt drahtlos, wodurch die Wahl von einigen verschiedenen Übertragungsprotokollen möglich ist. Die Eigenschaften
und Überlegungen, die hinter allen Systemeinzeilteilen stecken, werden in den Punkten 7 und 8 näher erläutert.

\subsubsection{Ausgabesubsystem}
