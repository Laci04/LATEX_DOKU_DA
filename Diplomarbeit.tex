...
\\
Zwischen jedem Fingerglied befindet sich ein enstprechender Abstand, verbunden sind diese durch einen Steg. Dieser hat den Zweck sich bei Zug an der Schnur zu biegen, durch 
die Führungen wird nur eine Biegung an diesem ermöglicht. Die Schnur wird an einer Halterung am Servomotor befestigt und dadurch bei Rotation des Servos 
...
bei Biegen des Fingers spannen. Daraus resultiert: Desto kürzer die Zugschnur im Finger, desto länger die 
Gummikordel. \\
...
er wird somit gesichert, um nicht weiter in Richtung Zug der Angelschnur zu kippen und 
...
\begin{itemize}
	...
	beiden Fingergliedern, welche zu einem für mehr Reibung gesorgt haben aber auch den einzelnen 
...
\hfill \break
\hfill \break
Der Mechanismus der zweiten Versuchshand, welche den Namen \textquote{Entwicklungsstufe: InMoov} trägt, \textquote{InMoov} ist äußerst umfangreich und weist meist bessere Lösungen für Features der ersten Versuchshand aus [\textcolor{blue}{\autoref{chap:Entwicklungsstufe: intitial}}] auf. \\
\\
\begin{figure}[H]
	\begin{center}
		\scalebox{1}
...
\textcolor{red}{
	In der Entwicklungsphase der mechnaischen Komponenten des Systems kam es zu vielen Höhen und Tiefen.
	Dieser Prozess war lange geprägt von einer Serie an Rückschlägen doch aufgrund der daraus entstanden
	Erkenntisse und Fortschritte konnte mechanisch ein System verwirklicht werden welches ...
}
\\
...
Die Software des Ausgabesubsystems, welche die intelligente Komponente dessen ist, 
hat gezeigt von welcher Bedeutung Ordnung während eines langfrisitgen Entwicklungsprozesses ist. 
Das entwickleter Code funktioniert ist die Grundvoraussetzung für dieses System, 
doch ohne die entsprechende Organisation und Ordnung rückt diese Aspekt schnell 
in den Hintergrund. 
...
Wodruch es immer eine Version gab die getestet ist und zuverlässig funktioniert, sowie auch eine 
...
die Software hat unterteilt sich somit auf in Komponenten welche im Hauptprogramm integriert werden.
...
Meist waren wenige Tests notwendig bis die Implementation dann vollendet war.

Äußerst lehrreich war die drahtlose Übertragung der Daten zwischen dem Eingabe- und Ausgabesbusystem,
diese hat für eine lange Zeit nicht funktioniert und war auch nicht äußerst stabil. 
Als die Datenübertragung erstmals möglich war, konnten die Hand mit dem Handschuh
...
\\
\textcolor{red}{
Zwar eignet sich der 3D-Druck mit dem Kunstoff PLA für einen Anfangsprototypen, zeigt jedoch auch, dass die daraus gewonnene Qualität langfristig keine Option ist.
Somit müssen besonders mechanische Komponenten mit Verfahren gefertigt werden, die auch Industiriell ihre Annerkennung finden. Besonders Zahnräder und Zahnstangen
...
besonders während dem Faltvorgang und müssen demnach auch aus einem härterem Kunstoff gefertigt werden.
}
\\
