...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|}
		...
		\hline
		4 & \fcolorbox{white}{white}{\parbox{5cm}{Die Roboterhand ist ein fertiges Design (3D Druck), dass im Projekt integriert wird.}} & Y & \fcolorbox{white}{white}{\parbox{3cm}{50 , weil das fertige Design verbessert und modifieziert wurde}} \\
        \hline
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|}
		...
		\hline
		14 & \fcolorbox{white}{white}{\parbox{5cm}{ - Annähen?}} & N & \fcolorbox{white}{white}{\parbox{3cm}{0, da die Sensoren anfangs angenäht wurden nun aber schlussendlich aber nicht}}  \\
        \hline
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|}
		...
		\hline
		34 & \fcolorbox{white}{white}{\parbox{5cm}{Jeder einzelne Servomotor soll eine Stromüberwachung haben.}} & Y & 70 \\
        \hline
...
integrierten Glieder, das P-Glied, das I-Glied sowie das D-Glieder, 
...
\section{VWA - Sicherheitsaspekte der MRK [\textcolor{blue}{Szabo}]}
...
Schnur an einer Halterung am Servomotor und wird dadurch bei Rotation des Servos 
...
Dabei gab es zahlreiche Erkenntnisse über die Reibung, Stabilität und mechanische Abnutzungen 
sowie aber auch das Verhalten der Gesamtmechanik bei Belastung. \\
\begin{figure}[H]
	\begin{center}
		\scalebox{0.8}
...
\\
Eine konkrete Lösung, um für mehr Zuverlässigkeit, im Zusammenhang mit dem Zugsystem 
zu sorgen wurde für diesen Aufbau eine Angelschnur gewählt, diese soll äußerst Riss- und Schnittfest sein. \\
\\
Im Versuch [siehe \textcolor{blue}{\autoref{chap:Versuchsaufbauten}}] hat sich erwiesen, dass ein Steg aus dem Kunststoff PLA welche die 
...
jeweilige Finger faltelt. Im Detail betrachtet beschränkt sich der Mechanismus 
...
\hfill \break
\hfill \break
Im Versuch der Entwicklungsstufe "initial" haben sich zahlreiche Problematiken und 
...
\hfill \break
\hfill \break
Der Mechanismus der zweiten Versuchshand, welche den Namen "Entwicklungsstufe: InMoov" trägt, \textquote{InMoov} ist äußerst umfangreich und weist meist bessere Lösungen für Features der ersten Versuchshand aus [\textcolor{blue}{\autoref{chap:Entwicklungsstufe: intitial}}] auf. \\
\\
\begin{figure}[H]
	\begin{center}
		\scalebox{1}
...
nur der Rückzug sowie die Faltung von ein und demselben Motor ausgelöst wird. Im Detail funktioniert der Mechanismus wie wie folgt: Am Servomotor wird eine runde Vorrichtung montiert, diese hat an der Außenkante 
