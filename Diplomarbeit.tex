...
aufgeteilt werden. \footnote{\url{https://www.rubigm.ruhr-uni-bochum.de/rubigm/mam/content/publications/scipub/mrk_leitfaden.pdf} (Stand: 05.03.2024, p.10)} \\
\\
...
folgenden Punkt werden diese Bereiche genannt und näher beschrieben. \footnote{\url{https://www.rubigm.ruhr-uni-bochum.de/rubigm/mam/content/publications/scipub/mrk_leitfaden.pdf} (Stand: 10.03.2024, p.10)}\\
\\
...
Schutzmaßnahmen vorhanden sein müssen. \footnote{\url{https://www.rubigm.ruhr-uni-bochum.de/rubigm/mam/content/publications/scipub/mrk_leitfaden.pdf} (Stand: 05.03.2024, p.11)} \\
\begin{figure}[H]
	\begin{center}
		\scalebox{0.4}
...
Kontakte zwischen Mensch und Roboter vermieden werden sollen. \footnote{\url{https://www.rubigm.ruhr-uni-bochum.de/rubigm/mam/content/publications/scipub/mrk_leitfaden.pdf} (Stand: 05.03.2024, p.11)}\\
\begin{figure}[H]
	\begin{center}
		\scalebox{0.4}
...
Synchronisation und Koexistenz. \footnote{\url{https://www.rubigm.ruhr-uni-bochum.de/rubigm/mam/content/publications/scipub/mrk_leitfaden.pdf} (Stand: 05.03.2024, p.11)}\\
\begin{figure}[H]
	\begin{center}
		\scalebox{0.4}
...
Arbeitsablaufs sein. \footnote{\url{https://www.rubigm.ruhr-uni-bochum.de/rubigm/mam/content/publications/scipub/mrk_leitfaden.pdf} (Stand: 05.03.2024, p.11)}\\
\begin{figure}[H]
	\begin{center}
		\scalebox{0.4}
		{\includegraphics[width=0.8 \linewidth]{Kollaboration}}
		\caption{Kollaboration}
...
\begin{itemize}
	...
	\item (D) DoS Angriffe
	\item Kompromittierung von Smartphones im Produktionsbetrieb
\end{itemize}
\hfill \break
...
außer Kraft gesetzt werden. \footnote{\url{https://tr.tuv.at/fileadmin/user_upload/docs/group/innovation/tuv-austria-white-paper-deutsch/003_tuv_austria_white_paper_III_einfluss_it_security_sicherheit_in_der_mensch_roboter_kollaboration_fraunhofer_DE_WEB.pdf} (Stand: 06.03.2024, p.12)}\\
\\
...
unbedingt eingehalten und dauerhaft verbessert werden müssen. Die schon vorhandenen 
...
\\
\textbf{Ergonomische Belastungen} \\
\\
MRKs (Mensch-Roboter-Kollaborationen) werden häufig verwendet, um Menschen bei 
körperlich schweren Arbeiten zu unterstützen und entlasten. Bei einer schlechten 
Auslegung des Arbeitsplatzes und der Interaktionsmöglichkeiten für den Menschen, 
kann dies allerdings zum Nachteil werden, da infolgedessen ergonomische 
Beschwerden entstehen können. Ziel ist es die Feinmotorik, Ausdauer und 
Schnelligkeit mit den gedanklichen Fähigkeiten des Arbeiters zu verbinden und 
nicht diesen weiter zu belasten. \\
\\
...
qualifizieren. \footnote{\url{https://opus.fhv.at/frontdoor/deliver/index/docId/4600/file/MRK_Gestaltungshilfe_fuer_MRK-Anwendungen.pdf} (Stand:11.03.2024, p.31-32)} \\
\\
...
verhindert werden können. \footnote{\url{https://www.isa.org/standards-and-publications/isa-standards/isa-iec-62443-series-of-standards} (Stand: 13.03.2024)} \\ 
\\
...
komplette Steuerungen in Safety Integrity Levels von 1 bis 4 eingestuft. \footnote{\url{https://www.pilz.com/de-DE/support/law-standards-norms/functional-safety/en-iec-61508} (Stand: 13.03.2024)}\\
\\
...
bekommen. \footnote{\url{https://www.tuvsud.com/de-de/indust-re/maschinensicherheit-info/maschinenrichtlinie} (Stand: 13.03.2024)}\\
\\
...
\paragraph{Kollaborative Roboter (Cobots)}
\hfill \break
\hfill \break
...
\paragraph{Menschenbezogene Sicherheitsmaßnahmen}
\hfill \break
\hfill \break
...
\hfill \break
\hfill \break
Der Mechanismus der zweiten Versuchshand \textquote{InMoov} ist äußerst umfangreich und weist meist bessere Lösungen für Features der ersten Versuchshand aus [\textcolor{blue}{\autoref{chap:Erste Testhand}}] auf. \\
\\
\begin{figure}[H]
	\begin{center}
		\scalebox{1}
...
ein hartes Material nicht immer die Beste Lösung ist. Der Vorschlag war Silikon in das Modell der Hand zu integrieren, ein ähnliches Projekt habe so bereits eine Hand realisiert. Ähnlich wie bei dem Modell aus [\textcolor{blue}{\autoref{chap:Erste Testhand}}] bestanden 
...
\hfill \break
\hfill \break
Für den Guss der gesamten Hand wird ähnlich wie bei dem Finger aus Versuch von Kapitel (x.x.x), eine Gussform benötigt, diese Gussform hat jedoch ein größeres Spektrum an Anforderungen. Mitunter muss berücksichtigt werden, dass das \textquote{Skelet} auch 
...
\label{chap:Vierte Hand (Hybrid-Konzept)}
...
Wie in [\textcolor{blue}{\autoref{chap:Erste Testhand}}] hat sich gezeigt, dass die einzelnen Fingerglieder sich kontinuierlich um die anderen Falten müssen. Auch hat sich im Kapitel „zweite Testhand“ gezeigt, wie wichtig es ist für ein Modell zu sorgen, dass einer hohen 
...
\\
Entdeckt wurde eine erweiterte Version der Hand aus [\textcolor{blue}{\autoref{chap:Zweite Testhand}}] von Gael Levin. Diese hat sämtliche Optimierungen, sei es die zu bemängelnde Stabilität der vorherigen Version oder auch der problematische Mechanismus der 
