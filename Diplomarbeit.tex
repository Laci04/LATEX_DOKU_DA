...
Die Bewgung des Nutzers darf durch den Handschuh nicht eingeschränkt werden und soll so widerstandslos wie möglich sein.
...
%-- HIER WIRD DIE ABBILDUNG VOM STOFF-HANDSCHUH BENOTIGT.s
...
Basis. Dieses Konzept schränkt die Bewegungen des Nutzers weniger als das vorherige es tat.
  %-- HIER WIRD DIE ABBILDUNG VON DEN RINGEN BENÖTIGT.
