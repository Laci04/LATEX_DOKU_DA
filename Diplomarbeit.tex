...
\subsection{Aktuatoren mit Positionsregelung}
\subsubsection{Überblick über Aktuatoren}
...
\begin{figure}[H]
	...
	\end{center}
\end{figure}
\paragraph{Diverse Arten von Aktuatoren und deren Anwendungsbereiche}
\hfill \break
\hfill \break
...
\subparagraph{Pneumatische Antriebe}
\hfill \break
\hfill \break
...
\subparagraph{Hydraulische Antriebe}
\hfill \break
\hfill \break
...
\subparagraph{Elektrische Antriebe}
\hfill \break
\hfill \break
...
\subparagraph{Thermische und magnetische Antriebe}
\hfill \break
\hfill \break
...
\subparagraph{Mechanische Antriebe}
\hfill \break
\hfill \break
...
\paragraph{Einführung in in den Servomotor}
\hfill \break
\hfill \break
...
\subparagraph{Grundlagen eines Servos}
\hfill \break
\hfill \break
...
\subparagraph{Aufbau und Funktionsprinzip eines Servomotors}
...
\paragraph{Positionsregelung}
\hfill \break
\hfill \break
\subparagraph{Einführung in die Positionsregelung}
\hfill \break
\hfill \break
...
Systeme. \\
\subparagraph{Theoretische Grundlagen}
\hfill \break
\hfill \break

\textbf{Theorie und essenzielle Begriffe} \\
\\
Eine Regelung basiert immer auf dem Prinzip ein gewisses Ziel zu 
erreichen und zu halten, ähnlich wie beim Erreichen eines Ziels gibt es 
einen Ist-Zustand und einen Soll-Zustand. Zur Veranschaulichung kann 
folgendes Beispiel genommen werden: Ist das Ziel Ein Kilometer zu laufen, 
dann kann dies als die Soll-Größe betrachtet werden – ist man gerade bei 
30\% der Strecke dann sind 300 Meter die Ist-Größe. Die Regelabweichung 
beschreibt die Differenz zwischen der Soll-Größe und der Ist-Größe und 
wäre in diesem Fall $700m$. Die daraus resultierende Stellgröße, wäre ein 
Maß für die Anweisung \textdegree{Laufen}. \\
\\
...
\\
Der erste Summand \textquote{kr} der Übertragungsfunktion ist der P-Regler, das 
...
Konstante \textquote{kr}. \footnote{\cite{Q9}}\textcolor{blue}{P-Regler} \\
\begin{figure}[H]
	\begin{center}
		\scalebox{1.2}
...
\end{figure}
\hfill \break
\subparagraph{Funktionsprinzip des Regelkreises}
\hfill \break
\hfill \break
Der Regelkreis einer Positionsregelung setzt sich aus mehreren 
Verschiedenen Komponenten zusammen, mitunter der PID-Regler als 
Kernglied, sowie auch weitere P und I Regler. \\
\begin{figure}[H]
	\begin{center}
		\scalebox{1.2}
...
\end{figure}
\hfill \break
Grundsätzlich beginnt der Kreislauf der Regelung mit einer Sollgröße, in 
diesem Fall ein Soll-Winkel von 100\textdegree. Vorhanden in der Simulation der 
Positionsregelung ist auch ein optionaler Sollsprung. Als wird der 
Sollwinkel von Grad in Radiant umgerechnet, folglich wird eine Differenz 
zwischen dem Soll- und dem aktuellen Drehwinkel gebildet. \\
\begin{figure}[H]
	\begin{center}
		\scalebox{1}
...
\end{figure}
\hfill \break
Die berechnete Differenz, welche die Regelabweichung darstellt, wird 
darauf an den PID-Regler übergeben, welche eine entsprechende Stellgröße 
an den Motor gibt. \\
\begin{figure}[H]
	\begin{center}
		\scalebox{1}
...
\end{figure}
\hfill \break
Beschreiben lässt sich der Motor anhand folgenden Blocks, welcher sich 
aus einem PT1-Glied und mechanischer Widerstände beziehungsweise 
Belastungen zusammensetzt. Als Verzögerungsglied erster Ordnung 
simuliert und beschreibt dieses das Anlaufverhalten des Motors. \footnote{\cite{Q12}} 
Zusätzlich werden das Lastmoment, die Reibung und die Trägheit in das 
System miteinkalkuliert. Wie in \textcolor{blue}{\autoref{par:Aufbau und Funktionsprinzip eines Servomotors}} 
bereits beschrieben, wird die Drehzahl mit einem 
Getriebe übersetzt, im Falle dieses Beispiels beträgt das 
Übersetzungsverhältnis des Getriebes 0,1. \\
\\
Finalerweise wird der Drehwinkel nochmals von Radiant in Grad 
rückgerechnet und der Drehwinkel ergibt sich, dieser wird anschließend 
als Feedback im Regelkreis rückgeführt und bietet eine Grundlage zur 
Berechnung der neuen Regelabweichung. \\
\begin{figure}[H]
	\begin{center}
		\scalebox{1.2}
...
\end{figure}
\hfill \break
Zu sehen sind in dieser Abbildung, drei Größen: In grün der Soll-Winkel, 
in blau der tatsächliche Drehwinkel (die Ist-Größe) und die Drehzahl ist 
orange gekennzeichnet. \\
Erkennen lässt sich, dass zum Zeitpunkt t=0 das System die Anweisung 
bekommt auf einen Winkel von 100\textdegree zu regeln. Nach 0,4 Sekunden wurde 
diese Position erreicht, jedoch zugleich überschritten, der Motor hat 
sich auf \~105\textdegree gedreht. Während diesem Vorgang ist die Drehzahl auf ein 
maximum von 10 Umdrehungen angestiegen, nach dem erreichen des Zielwerts 
sinkt die Drehzahl und somit auch der Drehwinkel bis dieser 100\textdegree 
erreicht. \\
...
\paragraph{Auswirkung auf Software und Kreativwerke}
\hfill \break
\hfill \break
...
\hfill \break
\hfill \break
\textbf{Motivation, Entstehung und Meilensteine} \\
\\
...
\end{itemize}
\hfill \break
\textbf{Momentaner Zustand und Erwartungen für zukünftige Trends} \\
\\
...
und 32\% der Befragten haben im Unternehmen schon eine Open Source Policy verankert. \\
\\
...
weltweiten Netz der Entwickler, die tagtäglich die Software versuchen ein Stück besser zu machen. 
...
auch auf diesen Bereich, da es immer häufiger zu Cyberattacken kommt, mehr Wert gelegt werden. \\
...
\\
\textbf{Kommerzielle Softwarelizenzen} \\
\\
...
\end{itemize}
\hfill \break
\textbf{GNU GPL (General Public License)} \\
\\
...
\begin{itemize}
	\item Eine wichtige Neuerung stellte die ,,Liberty or Death-Klausel“ dar. Diese wurde mit dem Sinn 
...
\begin{itemize}
	...
	\item o	im Falle des Vorhandenseins einer Textdatei mit dem Namen \textquote{NOTICE}, die 
...
\paragraph{Überblick der Lizenzen}
\hfill \break
\hfill \break
...
\paragraph{Hintergrund und Motivation}
\hfill \break
\hfill \break
...
\subsubsection{Grundlagen der Mensch-Roboter-Kollaboration}
...
\paragraph{Arten der Zusammenarbeit}
\hfill \break
\hfill \break
\textbf{Koexistenz} \\
\\
...
\paragraph{Gefahren und Risiken}
\hfill \break
\hfill \break
...
\\
\textbf{Unvorhersehbare Bewegungen} \\
\\
...
\paragraph{Sicherheitsstandards und Normen}
\hfill \break
\hfill \break
...
\\
\textbf{Maschinenrichtlinie 2006/47/EG} \\
\\
...
\\
\paragraph{Nationale Vorschriften (Österreich)}
\hfill \break
\hfill \break
...
\subsubsection{Lösungen zur Verbesserung der Sicherheit bei der MRK}
\paragraph{Sensortechnologien}
\hfill \break
\hfill \break
...
Start erfolgen. Dies nennt man auch \textdegree{Perceptual Aliasing} und beschreibt die 
...
\\
\paragraph{Softwarebasierte Sicherheitsmaßnahmen}
\hfill \break
\hfill \break
...
\paragraph{Physische Sicherheitsmaßnahmen}
\hfill \break
\hfill \break
\textbf{Roboterbezogen} \\
\\
...
\hfill \break
\hfill \break
Der Mechanismus der zweiten Versuchshand \textquote{InMoov} ist äußerst umfangreich und weist meist bessere Lösungen für Features der ersten Versuchshand aus [\textcolor{blue}{\autoref{chap:Entwicklungsstufe: intitial}}] auf. \\
\\
\begin{figure}[H]
	\begin{center}
		\scalebox{1}
...
\\
Montiert wird dieser Handgelenksmechanismus auf ein Unterarmkonstrukt, dieses besteht aus mehreren einzelnen Teilen um den Druck auf mit einem kleinen Drucker zu ermöglichen. Grundsätzlich sind alle Modelle des Projekts \textquote{InMoov} auf einem Drucker 
...
Gewählt wird die Open-Source Software Ultimaker Cura, in der Version 5.6.0, in diesem kann man zahlreiche Optionen treffen: Die Sichthöhe der einzelnen Scheiben, in Fachsprache \textquote{Layers}, die Druckgeschwindigkeit, die Füllungsdichte, ob Stützstrukturen für den 
...
\begin{figure}[H]
	\begin{center}
		...
		\caption{Modell der Silikonhand mit integrierten \textquote{Knochen Gelenken}}
...
\hfill \break
\hfill \break
Für den Guss der gesamten Hand wird ähnlich wie bei dem Finger aus [\textcolor{blue}{\autoref{par:Gussform}}], eine Gussform benötigt, diese Gussform hat jedoch ein größeres Spektrum an Anforderungen. Mitunter muss berücksichtigt werden, dass das \textquote{Skelet} auch 
...
Zugschnüren. Im neuen Modell der \textquote{i2Hand}, sind die Fingerglieder besonders an ihren Schwachstellen verstärkt worden, somit kann verhindert werden, dass die Verbindungen der einzelnen Glieder bei hoher Last oder gar der Montage brechen. Die 
...
\begin{figure}[H]
	\begin{center}
		...
		\caption{Programmfluss1}
		\label{fig:Programmfluss1_Roboterhand}		
	\end{center}
\end{figure}
\hfill \break
Das Diagramm in [\textcolor{blue}{\autoref{label:Programmfluss1_Roboterhand}}] veranschaulicht den Fluss empfangener Daten, diese durchlaufen bedingungsabhängig verschiedene Routen und 
...
welche die Roboterhand auf den Seriellen Monitor schreibt. Dies erfolgt durch den String \textquote{\$req.UI}, welcher vom Userinterface als Anweisung zum Antworten 
...
die erfassten Fingerpositionen mitteilen, werden auf dieser Route interpretiert und verarbeitet. In [\textcolor{red}{8.2.5.3 ESP-NOW und Wifi.h}] wird 
...
Dieser String wird daraufhin an die Komponente \textquote{interpretiere Daten} vom [\textcolor{red}{8.2.4.1 Parser und Interpretation: drahtloser Datenströme}] weitergegeben, 
...
eines Algorithmus die Sinnhaftigkeit der Daten überprüft. Eine genauere Erläuterung dieses Algorithmus ist in [\textcolor{red}{8.2.4.3 proaktiver Datenkorrekturalgorithmus}]
zu finden. \\
...
[\textcolor{red}{8.2.4.4 Datenaufbereitung und Anweisung für Servoaktoren}], dort wird der Positionswert des Fingers noch auf den Motor und seine Zugcharakteristik 
...
Interpretieren der Datenzuständig sind. Die Funktionalität beider Parser wird in [\textcolor{red}{8.2.4.1 Parser und Interpretation: drahtloser Datenströme}]
und [\textcolor{red}{8.2.4.2 Parser und Interpretation: serieller Datenströme}]. \\
\\
...
\$A:INDEX:WERT \\
\\
\textbf{\textquote{A}} bedeutet für das Userinterface, dass nun mit einem Messerwert der jeweiligen Ströme gerechnet werden muss. An der Stelle von \textbf{\textquote{INDEX}} ist ein Wert 
...
Wie in [\textcolor{red}{8.2.2.2 Effiziente Gliederung essenzieller Systemkomponenten}] bereits erläutert, setzt sich das Hauptprogramm aus mehreren 
...
\hfill \break
\normalsize
Das Unterprogramm prüft ob die Grundbedingungen, somit das erforderte Format wie in [\textcolor{red}{8.2.3.1 Drahtlose Kommunikation}] beschrieben, erfüllt wird. \\
...
\paragraph{Parser und Interpreatation: serieller Datenströme}
\hfill \break
\hfill \break
...
die serielle Schnittstelle empfangenen Daten zu parsen.  Wie in [\textcolor{red}{8.2.3.2 Serielle Kommunikation}] beschrieben, hat dieser Parser mit 
...
\\
Die Funktion \textquote{HPCA9685.Servo} erfordert einen anderen Wertebereich als der empfangene von 0 bis 100 und somit müssen diese Werte gemappt werden. \\
\\
\footnotesize
\begin{lstlisting}
